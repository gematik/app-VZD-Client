...
Dies ist die einzige Funktion die eine .txt-Datei als Befehlsdatei entgegen nimmt. Jede Zeile repräsentiert hier eine Uid auf die ein <<_read_directory_entry_certificate, Read>> ausgeführt wird.
