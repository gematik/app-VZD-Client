...
public class DirectoryEntryAdministrationApiTest {
    ...
    public void readDirectoryEntryTest() throws ApiException {
        ...
        List<DirectoryEntry> response = api
            .readDirectoryEntry(uid, givenName, sn, cn, displayName, streetAddress, postalCode, localityName, stateOrProvienceName, title,
                organization, otherName, specialization, domainID, personalEntry, dataFromAuthority);
