...
public class DeleteDirEntryCertExecutionIntegrationTest {
    ...
    private static final String[] TEST_ARGS = new String[]{"-p",
        ...
        + "config" + File.separator + "commands" + File.separator + "delCert.xml"};
    ...
    @Test
    public void delCertCommandSuccessTest() throws Exception {
        DeleteDirEntryCertExecution deleteDirEntryCertExecution = new DeleteDirEntryCertExecution(ConnectionPool.createConnectionPool(1));
        assertTrue(deleteDirEntryCertExecution.createCallable(commands.get(0)).call());
    }

    @Test
    public void delCertCommandFailTest() throws Exception {
        DeleteDirEntryCertExecution deleteDirEntryCertExecution = new DeleteDirEntryCertExecution(ConnectionPool.createConnectionPool(1));
        assertFalse(deleteDirEntryCertExecution.createCallable(commands.get(1)).call());
    }
    ...
    public void executeCommandExceptionTest() {
        ...
        ApiException exception = assertThrows(ApiException.class,
            () -> deleteDirEntryCertExecution.executeCommand(commands.get(1), deleteDirEntryCertExecution.connectionPool.getConnection()));
