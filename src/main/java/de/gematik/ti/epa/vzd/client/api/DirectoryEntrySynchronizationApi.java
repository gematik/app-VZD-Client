...
public class DirectoryEntrySynchronizationApi {
    ...
    private okhttp3.Call readDirectoryEntryForSyncValidateBeforeCall(String uid, String givenName, String sn, String cn, String displayName, String streetAddress, String postalCode, String countryCode, String localityName, String stateOrProvinceName, String title, String organization, String otherName, String telematikID, String telematikIDSubStr, String specialization, String domainID, String holder, String personalEntry, String dataFromAuthority, Boolean baseEntryOnly, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = readDirectoryEntryForSyncCall(uid, givenName, sn, cn, displayName, streetAddress, postalCode, countryCode, localityName, stateOrProvinceName, title, organization, otherName, telematikID, telematikIDSubStr, specialization, domainID, holder, personalEntry, dataFromAuthority, baseEntryOnly, _callback);
        return localVarCall;
     ...
     */
    public List<DirectoryEntry> readDirectoryEntryForSync(String uid, String givenName, String sn, String cn, String displayName, String streetAddress, String postalCode, String countryCode, String localityName, String stateOrProvinceName, String title, String organization, String otherName, String telematikID, String telematikIDSubStr, String specialization, String domainID, String holder, String personalEntry, String dataFromAuthority, Boolean baseEntryOnly) throws ApiException {
        ApiResponse<List<DirectoryEntry>> localVarResp = readDirectoryEntryForSyncWithHttpInfo(uid, givenName, sn, cn, displayName, streetAddress, postalCode, countryCode, localityName, stateOrProvinceName, title, organization, otherName, telematikID, telematikIDSubStr, specialization, domainID, holder, personalEntry, dataFromAuthority, baseEntryOnly);
     ...
     */
    public ApiResponse<List<DirectoryEntry>> readDirectoryEntryForSyncWithHttpInfo(String uid, String givenName, String sn, String cn, String displayName, String streetAddress, String postalCode, String countryCode, String localityName, String stateOrProvinceName, String title, String organization, String otherName, String telematikID, String telematikIDSubStr, String specialization, String domainID, String holder, String personalEntry, String dataFromAuthority, Boolean baseEntryOnly) throws ApiException {
        okhttp3.Call localVarCall = readDirectoryEntryForSyncValidateBeforeCall(uid, givenName, sn, cn, displayName, streetAddress, postalCode, countryCode, localityName, stateOrProvinceName, title, organization, otherName, telematikID, telematikIDSubStr, specialization, domainID, holder, personalEntry, dataFromAuthority, baseEntryOnly, null);
        Type localVarReturnType = new TypeToken<List<DirectoryEntry>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Synchronisation der Verzeichniseinträge zwischen VZD und Herausgeber (asynchronously)
     * Liefert - analog zu read_Directory_Entry - alle zum Filter passenden Verzeichniseinträge. Im Unterschied zu read_Directory_Entry wird die Limitierung auf 100 Suchergebnisse aufgehoben. Die parallele Ausführung dieser Operation wird vom Server aus Performancegründen eingeschränkt. Diese Operation soll nur genutzt werden, wenn mehr als 100 Suchergebnisse benötigt werden. Für alle anderen Suchanfragen soll Operation read_Directory_Entry genutzt werden.
     * @param uid ID von dem Verzeichniseintrag (distinguishedName.uid) (optional)
     * @param givenName Erlaubt die Suche mit Hilfe des Attributs givenName. (optional)
     * @param sn Erlaubt die Suche mit Hilfe des Attributs sn. (optional)
     ...
     */
    public okhttp3.Call readDirectoryEntryForSyncAsync(String uid, String givenName, String sn, String cn, String displayName, String streetAddress, String postalCode, String countryCode, String localityName, String stateOrProvinceName, String title, String organization, String otherName, String telematikID, String telematikIDSubStr, String specialization, String domainID, String holder, String personalEntry, String dataFromAuthority, Boolean baseEntryOnly, final ApiCallback<List<DirectoryEntry>> _callback) throws ApiException {
