...
public class Contact {
  ...
  **/
  ...
  public Contact url(URI url) {
   ...
   /**
   * Eine URL zu den Kontaktinformationen für dieses API. In dem Dokument unter dieser URL muss ein Link zum Download der aktuell genutzten YAML Datei dieser Schnittstelle hinterlegt sein.
   * @return url
  **/
  @javax.annotation.Nullable
