...
public class DistinguishedName {
  ...
  public DistinguishedName uid(String uid) {
   ...
   /**
   * entryID: Name/ID, den den Eintrag eindeutig identifiziert. Hat für den Verzeichnisdienst_Eintrag, Certificate, KOM-LE_Fachdaten und FAD1 eines Verzeichniseintrags den gleichen Wert.
   * @return uid
  **/
