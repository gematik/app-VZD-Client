...
public class GemDirectoryEntrySynchronizationApi extends DirectoryEntrySynchronizationApi {
    ...
    @Override
    public okhttp3.Call readDirectoryEntryForSyncCall(String uid, String givenName, String sn, String cn, String displayName, String streetAddress,
        ...
        String telematikID, String telematikIDSubStr, String specialization, String domainID, String owner, String personalEntry,
        String dataFromAuthority, Boolean baseEntryOnly, final ApiCallback _callback) throws ApiException {
        ...
        if (telematikIDSubStr != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("telematikID-SubStr", telematikIDSubStr));
        }
