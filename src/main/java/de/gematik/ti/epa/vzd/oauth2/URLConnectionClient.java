...
package de.gematik.ti.epa.vzd.oauth2;
...
public class URLConnectionClient implements HttpClient {
  ...
  @Override
  public <T extends OAuthClientResponse> T execute(final OAuthClientRequest request,
    ...
    return OAuthClientResponseFactory
        .createCustomResponse(responseBody, c.getContentType(), responseCode, responseHeaders,
            responseClass);
  }
