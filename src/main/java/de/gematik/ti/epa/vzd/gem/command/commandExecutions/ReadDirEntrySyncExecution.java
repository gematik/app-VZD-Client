...
public class ReadDirEntrySyncExecution extends ReadDirEntryExecution {
    ...
    public ExecutionResult executeCommand(CommandType command, GemApiClient apiClient) throws ApiException {
        ...
        ApiResponse<List<DirectoryEntry>> response =
            new GemDirectoryEntrySynchronizationApi(apiClient)
                .readDirectoryEntryForSyncWithHttpInfo(uid, givenName, sn, cn, displayName, streetAddress, postalCode, countryCode, localityName,
                    stateOrProvinceName, title, organization, otherName, telematikID, telematikIDSubStr, specialization, domainID, owner,
