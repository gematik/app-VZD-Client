...
public class SafeModifyDirEntryExecution extends ExecutionBase {
    ...
    private CommandType getSaveCommand(CommandType command, GemApiClient apiClient) throws ApiException, DatatypeConfigurationException {
    ...
    protected ExecutionResult executeCommand(CommandType command, GemApiClient apiClient)
        ...
        BaseDirectoryEntry baseDirectoryEntry = Transformer.getBaseDirectoryEntryFromCommandType(safeCommand);
