...
public class ApiClient {
  ...
  public ApiClient(String clientId, String clientSecret, Map<String, String> parameters) {
    ...
    RetryingOAuth retryingOAuth = new RetryingOAuth("https://to.be.defined/oauth/token", clientId,
        OAuthFlow.application, clientSecret,
        parameters);
    authentications.put(
        "OAuth2",
        retryingOAuth
  ...
  private void init() {
    ...
    setUserAgent("OpenAPI-Generator/1.6.3/java");
  ...
  public Call buildCall(String path, String method, List<Pair> queryParams,
      ...
      Map<String, Object> formParams, String[] authNames, ApiCallback callback)
      throws ApiException {
    Request request = buildRequest(path, method, queryParams, collectionQueryParams, body,
        headerParams, cookieParams, formParams, authNames,
        callback);
