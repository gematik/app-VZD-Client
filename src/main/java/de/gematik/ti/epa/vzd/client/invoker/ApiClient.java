...
public class ApiClient {
    ...
    private String basePath = "https://to.be.defined";
    ...
    public ApiClient(String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        RetryingOAuth retryingOAuth = new RetryingOAuth("https://to.be.defined/oauth/token", clientId, OAuthFlow.application, clientSecret,
            parameters);
        authentications.put(
            "OAuth2",
            retryingOAuth
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://to.be.defined
    ...
    /**
     * The path of temporary folder used to store downloaded files from endpoints with file response. The default value is <code>null</code>, i.e.
     * using the system's default tempopary folder.
     *
    ...
    /**
     * Sets the connect timeout (in milliseconds). A value of 0 means no timeout, otherwise values must be between 1 and {@link Integer#MAX_VALUE}.
     *
    ...
    /**
     * Sets the read timeout (in milliseconds). A value of 0 means no timeout, otherwise values must be between 1 and {@link Integer#MAX_VALUE}.
     *
    ...
    /**
     * Sets the write timeout (in milliseconds). A value of 0 means no timeout, otherwise values must be between 1 and {@link Integer#MAX_VALUE}.
     *
    ...
    /**
     * Select the Accept header's value from the given accepts array: if JSON exists in the given array, use it; otherwise use all of them (joining
     * into a string)
     *
     ...
     * @throws ApiException If fail to deserialize response body, i.e. cannot read response body or the Content-Type of the response is not
     *                      supported.
     */
     ...
     * @param call       Call
     * @return ApiResponse object containing response status, headers and data, which is a Java object deserialized from response body and would be
     ...
     * @param returnType Return type
     * @return Type
     * @throws ApiException If the response has an unsuccessful status code or fail to deserialize the response body
     */
    ...
    public Call buildCall(String path, String method, List<Pair> queryParams, List<Pair> collectionQueryParams, Object body,
        Map<String, String> headerParams, Map<String, String> cookieParams, Map<String, Object> formParams, String[] authNames, ApiCallback callback)
        throws ApiException {
        Request request = buildRequest(path, method, queryParams, collectionQueryParams, body, headerParams, cookieParams, formParams, authNames,
            callback);
        ...
        for (Entry<String, Object> param : formParams.entrySet()) {
            if (param.getValue() instanceof File) {
                ...
                Headers partHeaders = Headers
                    .of("Content-Disposition", "form-data; name=\"" + param.getKey() + "\"; filename=\"" + file.getName() + "\"");
     ...
     */
    public Interceptor getProgressInterceptor() {
