...
public class JSON {
            ...
            switch (in.peek()) {
                ...
                default:
                    ...
                    try {
                        ...
                        OffsetDateTime time = LocalDateTime.ofInstant(Instant.ofEpochMilli(Long.parseLong(date)), TimeZone.getDefault().toZoneId())
                            .atOffset(ZoneOffset.UTC);
                        LOG.warn("Invalid time found - converted timestamp {} to {}", date, time);
                        return time;
                    }
    ...
    /**
     * Gson TypeAdapter for java.sql.Date type If the dateFormat is null, a simple "yyyy-MM-dd" format will be used (more efficient than
     * SimpleDateFormat).
     */
