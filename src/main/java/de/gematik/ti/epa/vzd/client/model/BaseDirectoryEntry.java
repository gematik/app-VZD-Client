...
public class BaseDirectoryEntry {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(dn, givenName, sn, cn, displayName, streetAddress, postalCode, countryCode, localityName, stateOrProvinceName, title, organization, otherName, telematikID, specialization, domainID, holder, maxKOMLEadr, personalEntry, dataFromAuthority, changeDateTime, professionOID, entryType);
  }
