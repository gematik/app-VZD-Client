...
public class DirectoryEntryAdministrationApi {
    ...
    private okhttp3.Call addDirectoryEntryValidateBeforeCall(CreateDirectoryEntry createDirectoryEntry, final ApiCallback _callback) throws ApiException {
     ...
     */
    public okhttp3.Call addDirectoryEntryAsync(CreateDirectoryEntry createDirectoryEntry, final ApiCallback<DistinguishedName> _callback) throws ApiException {
     ...
     * @param uid ID von dem zu löschenden Verzeichniseintrag Gelöscht werden der Basis Verzeichniseintrag sowie alle dazugehörenden Zertifikate und Fachdaten. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call deleteDirectoryEntryAsync(String uid, final ApiCallback<Object> _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call modifyDirectoryEntryValidateBeforeCall(String uid, BaseDirectoryEntry baseDirectoryEntry, final ApiCallback _callback) throws ApiException {
     ...
     */
    public okhttp3.Call modifyDirectoryEntryAsync(String uid, BaseDirectoryEntry baseDirectoryEntry, final ApiCallback<DistinguishedName> _callback) throws ApiException {
     ...
     * @param telematikID Erlaubt die Suche mit Hilfe des Attributs telematikID (die telematikID in den Basisdaten). (optional)
     * @param telematikIDSubStr Erlaubt die Suche nach einem Substring am Anfang der telematikID (die telematikID in den Basisdaten). Entspricht der LDAP Filters Substring Assertion vom Typ \&quot;subInitial Component\&quot;. (optional)
     * @param specialization Erlaubt die Suche mit Hilfe des Attributs specialization. Der Verzeichniseintrag wird selektiert, wenn die angegebene domainID im Attribut domainID (array) des Verzeichniseintrags enthalten ist. (optional)
     * @param domainID Erlaubt die Suche mit Hilfe des Attributs domainID. Der Verzeichniseintrag wird selektiert, wenn die angegebene domainID im Attribut domainID (array) des Verzeichniseintrags enthalten ist. (optional)
     * @param holder Erlaubt die Suche mit Hilfe des Attributs holder. Der Verzeichniseintrag wird selektiert, wenn der angegebene holder im Attribut holder (array) des Verzeichniseintrags enthalten ist. Wenn der Parameter mit dem eigenen Wert des Clients belegt wird, werden alle gefundenen Einträge zurückgegeben (maximal 100 Einträge). Zur Suche nach Einträge ohne holder ist der Parameter mit dem einem leeren String \&quot;\&quot; zu belegen. Auch in diesem Fall werden alle gefundenen Einträge zurückgegeben (maximal 100 Einträge). (optional)
     ...
     * @param professionOID Erlaubt die Suche mit Hilfe des Attributs professionOID. Selektiert der Verzeichniseintrag, wenn der angegebene Wert in den professionOID&#39;s (array) des Basiseintrags vorhanden ist. (optional)
     * @param entryType Erlaubt die Suche mit Hilfe des Attributs entryType. Selektiert der Verzeichniseintrag, wenn der angegebene Wert in den entryType&#39;s (array) des Basiseintrags vorhanden ist. (optional)
     * @param baseEntryOnly Mit baseEntryOnly &#x3D; \&quot;true\&quot; wird nur der Basiseintrag (baseDirectoryEntry) im Response zurückgegeben. Falls nicht angegeben oder mit \&quot;false\&quot; belegt, wird der gesamte Verzeichniseintrag mit Zertifikaten und Fachdaten im Response zurückgegeben. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call readDirectoryEntryCall(String uid, String givenName, String sn, String cn, String displayName, String streetAddress, String postalCode, String countryCode, String localityName, String stateOrProvinceName, String title, String organization, String otherName, String telematikID, String telematikIDSubStr, String specialization, String domainID, String holder, String personalEntry, String dataFromAuthority, String professionOID, String entryType, Boolean baseEntryOnly, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    private okhttp3.Call readDirectoryEntryValidateBeforeCall(String uid, String givenName, String sn, String cn, String displayName, String streetAddress, String postalCode, String countryCode, String localityName, String stateOrProvinceName, String title, String organization, String otherName, String telematikID, String telematikIDSubStr, String specialization, String domainID, String holder, String personalEntry, String dataFromAuthority, String professionOID, String entryType, Boolean baseEntryOnly, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = readDirectoryEntryCall(uid, givenName, sn, cn, displayName, streetAddress, postalCode, countryCode, localityName, stateOrProvinceName, title, organization, otherName, telematikID, telematikIDSubStr, specialization, domainID, holder, personalEntry, dataFromAuthority, professionOID, entryType, baseEntryOnly, _callback);
        return localVarCall;
     ...
     */
    public List<DirectoryEntry> readDirectoryEntry(String uid, String givenName, String sn, String cn, String displayName, String streetAddress, String postalCode, String countryCode, String localityName, String stateOrProvinceName, String title, String organization, String otherName, String telematikID, String telematikIDSubStr, String specialization, String domainID, String holder, String personalEntry, String dataFromAuthority, String professionOID, String entryType, Boolean baseEntryOnly) throws ApiException {
        ApiResponse<List<DirectoryEntry>> localVarResp = readDirectoryEntryWithHttpInfo(uid, givenName, sn, cn, displayName, streetAddress, postalCode, countryCode, localityName, stateOrProvinceName, title, organization, otherName, telematikID, telematikIDSubStr, specialization, domainID, holder, personalEntry, dataFromAuthority, professionOID, entryType, baseEntryOnly);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<DirectoryEntry>> readDirectoryEntryWithHttpInfo(String uid, String givenName, String sn, String cn, String displayName, String streetAddress, String postalCode, String countryCode, String localityName, String stateOrProvinceName, String title, String organization, String otherName, String telematikID, String telematikIDSubStr, String specialization, String domainID, String holder, String personalEntry, String dataFromAuthority, String professionOID, String entryType, Boolean baseEntryOnly) throws ApiException {
        okhttp3.Call localVarCall = readDirectoryEntryValidateBeforeCall(uid, givenName, sn, cn, displayName, streetAddress, postalCode, countryCode, localityName, stateOrProvinceName, title, organization, otherName, telematikID, telematikIDSubStr, specialization, domainID, holder, personalEntry, dataFromAuthority, professionOID, entryType, baseEntryOnly, null);
        Type localVarReturnType = new TypeToken<List<DirectoryEntry>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Gesamten Verzeichniseintrag lesen (asynchronously)
     * Liefert alle zum Filter passenden Verzeichniseinträge (maximal 100 Einträge). Die angegebenen Parameter werden mit logischen UND verknüpft.
     * @param uid ID von dem Verzeichniseintrag (distinguishedName.uid) (optional)
     * @param givenName Erlaubt die Suche mit Hilfe des Attributs givenName. (optional)
     * @param sn Erlaubt die Suche mit Hilfe des Attributs sn. (optional)
     ...
     */
    public okhttp3.Call readDirectoryEntryAsync(String uid, String givenName, String sn, String cn, String displayName, String streetAddress, String postalCode, String countryCode, String localityName, String stateOrProvinceName, String title, String organization, String otherName, String telematikID, String telematikIDSubStr, String specialization, String domainID, String holder, String personalEntry, String dataFromAuthority, String professionOID, String entryType, Boolean baseEntryOnly, final ApiCallback<List<DirectoryEntry>> _callback) throws ApiException {
