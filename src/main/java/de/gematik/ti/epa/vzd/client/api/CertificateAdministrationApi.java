...
public class CertificateAdministrationApi {
    ...
    private okhttp3.Call addDirectoryEntryCertificateValidateBeforeCall(String uid, UserCertificate userCertificate, final ApiCallback _callback) throws ApiException {
     ...
     */
    public okhttp3.Call addDirectoryEntryCertificateAsync(String uid, UserCertificate userCertificate, final ApiCallback<DistinguishedName> _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteDirectoryEntryCertificateValidateBeforeCall(String uid, String certificateEntryID, final ApiCallback _callback) throws ApiException {
     ...
     */
    public okhttp3.Call deleteDirectoryEntryCertificateAsync(String uid, String certificateEntryID, final ApiCallback<Void> _callback) throws ApiException {
     ...
     * @param certificateEntryID ID von dem Zertifikat (dn.cn vom Zertifikatseintrag) Wenn angegeben wird das adressierte (certificateEntryID) Zertifikat geliefert. Wenn nicht angegeben werden alle Zertifikate des übergeordneten Verzeichniseintrags geliefert. (optional)
     ...
     * @param professionOID Erlaubt die Suche mit Hilfe des Attributs professionOID. Der Verzeichniseintrag wird selektiert, wenn die angegebene professionOID im Attribut professionOID (array) des Zertifikatseintrags enthalten ist. (optional)
     * @param usage Erlaubt die Suche mit Hilfe des Attributs usage. Der Verzeichniseintrag wird selektiert, wenn die angegebene usage im Attribut usage (array) des Zertifikatseintrags enthalten ist. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call readDirectoryCertificatesCall(String uid, String certificateEntryID, String entryType, String telematikID, String professionOID, String usage, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call readDirectoryCertificatesValidateBeforeCall(String uid, String certificateEntryID, String entryType, String telematikID, String professionOID, String usage, final ApiCallback _callback) throws ApiException {
    ...
    public List<UserCertificate> readDirectoryCertificates(String uid, String certificateEntryID, String entryType, String telematikID, String professionOID, String usage) throws ApiException {
        ApiResponse<List<UserCertificate>> localVarResp = readDirectoryCertificatesWithHttpInfo(uid, certificateEntryID, entryType, telematikID, professionOID, usage);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<List<UserCertificate>> readDirectoryCertificatesWithHttpInfo(String uid, String certificateEntryID, String entryType, String telematikID, String professionOID, String usage) throws ApiException {
        okhttp3.Call localVarCall = readDirectoryCertificatesValidateBeforeCall(uid, certificateEntryID, entryType, telematikID, professionOID, usage, null);
        Type localVarReturnType = new TypeToken<List<UserCertificate>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Zertifikat lesen (asynchronously)
     * Liefert alle Zertifikate, die dem Filter (siehe &#39;parameters&#39;) entsprechen.
     * @param uid ID vom übergeordneten Verzeichniseintrag (optional)
     * @param certificateEntryID ID von dem Zertifikat (dn.cn vom Zertifikatseintrag) Wenn angegeben wird das adressierte (certificateEntryID) Zertifikat geliefert. Wenn nicht angegeben werden alle Zertifikate des übergeordneten Verzeichniseintrags geliefert. (optional)
     * @param entryType Erlaubt die Suche mit Hilfe des Attributs entryType. (optional)
     ...
     */
    public okhttp3.Call readDirectoryCertificatesAsync(String uid, String certificateEntryID, String entryType, String telematikID, String professionOID, String usage, final ApiCallback<List<UserCertificate>> _callback) throws ApiException {

        okhttp3.Call localVarCall = readDirectoryCertificatesValidateBeforeCall(uid, certificateEntryID, entryType, telematikID, professionOID, usage, _callback);
        Type localVarReturnType = new TypeToken<List<UserCertificate>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
