...
public class CertificateAdministrationApi {
     ...
     *                        telematikID       Kann optional belegt werden. Wird telematikID angegeben, dann muss diese telematikID mit der
     *                        telematikID im userCertificate übereinstimmen. Bei unterschiedlichen telematikID wird die Operation mit Fehlercode 422
     *                        abgelehnt. entryType         Nicht vorhanden (wird vom Verzeichnisdienst belegt) professionOID     Nicht vorhanden (wird
     *                        vom Verzeichnisdienst belegt) usage             Kann optional belegt werden userCertificate   Muss vorhanden sein
     *                        description       Kann optional belegt werden (required)
     ...
     * </table>
     */
    public okhttp3.Call addDirectoryEntryCertificateCall(String uid, UserCertificate userCertificate, final ApiCallback _callback)
        throws ApiException {
    ...
    public DistinguishedName addDirectoryEntryCertificate(String uid, UserCertificate userCertificate) throws ApiException {
        ApiResponse<DistinguishedName> localVarResp = addDirectoryEntryCertificateWithHttpInfo(uid, userCertificate);
     ...
     * </table>
     */
    public okhttp3.Call addDirectoryEntryCertificateAsync(String uid, UserCertificate userCertificate, final ApiCallback<DistinguishedName> _callback)
        throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call deleteDirectoryEntryCertificateAsync(String uid, String certificateEntryID, final ApiCallback<Void> _callback)
        throws ApiException {
     ...
     *                           certificateEntryID in Path). telematikID       Kann optional belegt werden. Wird telematikID angegeben, dann muss
     *                           diese telematikID mit der telematikID im userCertificate übereinstimmen. Bei unterschiedlichen telematikID wird die
     *                           Operation mit Fehlercode 422 abgelehnt. entryType         Nicht vorhanden (wird vom Verzeichnisdienst belegt)
     *                           professionOID     Nicht vorhanden (wird vom Verzeichnisdienst belegt) usage             Kann optional belegt werden.
     *                           userCertificate   unverändert gegenüber VZD description       Kann optional belegt werden. (required)
     * @param _callback          Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details <table summary="Response Details" border="1">
     ...
     * </table>
     */
    public UserCertificate modifyDirectoryEntryCertificate(String uid, String certificateEntryID, UserCertificate userCertificate)
        throws ApiException {
        ApiResponse<UserCertificate> localVarResp = modifyDirectoryEntryCertificateWithHttpInfo(uid, certificateEntryID, userCertificate);
        return localVarResp.getData();
    }
     ...
     * </table>
     */
    public ApiResponse<UserCertificate> modifyDirectoryEntryCertificateWithHttpInfo(String uid, String certificateEntryID,
        ...
        Type localVarReturnType = new TypeToken<UserCertificate>() {
        }.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public okhttp3.Call modifyDirectoryEntryCertificateAsync(String uid, String certificateEntryID, UserCertificate userCertificate,
        final ApiCallback<UserCertificate> _callback) throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call readDirectoryCertificatesCall(String uid, String certificateEntryID, String entryType, String telematikID,
     ...
     * </table>
     */
    public List<UserCertificate> readDirectoryCertificates(String uid, String certificateEntryID, String entryType, String telematikID,
        String professionOID, String usage) throws ApiException {
        ApiResponse<List<UserCertificate>> localVarResp = readDirectoryCertificatesWithHttpInfo(uid, certificateEntryID, entryType, telematikID,
            professionOID, usage);
        return localVarResp.getData();
    }
     ...
     * </table>
     */
    public ApiResponse<List<UserCertificate>> readDirectoryCertificatesWithHttpInfo(String uid, String certificateEntryID, String entryType,
     ...
     * </table>
     */
    public okhttp3.Call readDirectoryCertificatesAsync(String uid, String certificateEntryID, String entryType, String telematikID,
        String professionOID, String usage, final ApiCallback<List<UserCertificate>> _callback) throws ApiException {
